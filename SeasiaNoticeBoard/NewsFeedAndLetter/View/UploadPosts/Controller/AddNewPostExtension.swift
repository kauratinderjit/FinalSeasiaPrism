...
extension AddNewsFeedPostsVC : UICollectionViewDelegate,UICollectionViewDataSource
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        cellnew.btnDelete.frame = CGRect(x: self.view.frame.origin.x + self.view.frame.size.width - 73 , y: cellnew.ivImg.frame.origin.y, width: 32, height: 32)
        ...
        else
        {
            ...
            do {
                if img != nil {
                    ...
                    cellnew.ivImg.image = UIImage(data: imageData)?.fixOrientation() ?? UIImage(named:"profile")!
