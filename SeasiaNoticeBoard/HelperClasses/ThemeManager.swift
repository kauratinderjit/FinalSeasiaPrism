...
class Theme {
    ...
    var mainColor: UIColor = UIColor.colorFromHexString("18AE7A")//UIColor.colorFromHexString("A90222")
    var textFieldBackgroundColor : UIColor = .white
    var uiButtonBackgroundColor : UIColor = UIColor.init(red: 24/255, green: 174/255, blue: 122/255, alpha: 1)
    ...
    var navigationTintColor : UIColor = UIColor.colorFromHexString("18AE7A")//UIColor.colorFromHexString("FFFFFF")
    var navigationBarTintColor : UIColor = UIColor.colorFromHexString("18AE7A")//UIColor.colorFromHexString("A90222")
    var labelBackgroundColor : UIColor = UIColor.colorFromHexString("18AE7A")//UIColor.colorFromHexString("A90222")
    var statusBarColr : UIColor = UIColor.colorFromHexString("18AE7A")//UIColor.colorFromHexString("A90222")
