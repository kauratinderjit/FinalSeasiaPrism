...
class ProfileNewsFeedVC: BaseUIViewController {
    ...
    func getNewfeedData() {
        skip = 0
        self.viewModel?.getDataProfile(UserId: otherUserId  , Search: "",Skip: 0,PageSize: KIntegerConstants.kInt10,SortColumnDir : "",SortColumn: "",ParticularId:  UserDefaultExtensionModel.shared.currentUserId)
    }
...
//            {
                ...
                if otherUserId !=  UserDefaultExtensionModel.shared.currentUserId {
                    lblname.text = name
                    lblStatus.text = status
                     if  img != ""
                         {
                profileImage.sd_setImage(with: URL(string: img), placeholderImage: UIImage(named: "profileImage"), options: SDWebImageOptions(rawValue: 0))
                { (image, error, cacheType, imageURL) in
                  ...
                  self.button.contentMode = .scaleAspectFill
                                         ...
                                         self.button.setImage(UIImage(named: "profileImage"), for: .normal)
                                        }
        }
                    
                
                else {
                    lblname.text = AppDefaults.shared.userFirstName + " " + AppDefaults.shared.userLastName
                           lblStatus.text = AppDefaults.shared.bio
                    if  img != ""
                                       {
                    profileImage.sd_setImage(with: URL(string: AppDefaults.shared.userImage), placeholderImage: UIImage(named: "profileImage"), options: SDWebImageOptions(rawValue: 0))
                               { (image, error, cacheType, imageURL) in
                                   self.profileImage.image = image
                                 self.button.contentMode = .scaleAspectFill
                               }
...
//                      viewprofile = "true"
//                      emailOtheruser = newsData[sender.tag].Email ?? ""
//                       newViewController.modalPresentationStyle = .fullScreen
//                     self.navigationController?.pushViewController(newViewController, animated: true)
//
//
...
//
    ...
    @IBAction func viewEditProfile(_ sender: UIButton) {
        if checkInternetConnection(){
                 let storyBoard: UIStoryboard = UIStoryboard(name: "Login", bundle: nil)
                  let newViewController = storyBoard.instantiateViewController(withIdentifier: "SignUpViewController") as! SignUpViewController
                             newViewController.otherUserId = otherUserId
                         newViewController.viewprofile = viewprofile
                         newViewController.emailOtheruser = emailOtheruser
                          newViewController.modalPresentationStyle = .fullScreen
                        self.navigationController?.pushViewController(newViewController, animated: true)
...
extension ProfileNewsFeedVC : UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
              ...
              cell.likeImage.image = UIImage(named: "unlike")
                         ...
                         self.taggedUsersData = dic.TaggedUsers
                                  ...
                                  //    cell.heightCollectionViewTag.constant = 27
                                       ...
                                       cell.topSpaceCollImages.constant = -32
                                    // cell.heightCollectionViewTag.constant = 1
     ...
     extension ProfileNewsFeedVC : UICollectionViewDelegate,UICollectionViewDataSource
     {
     ...
     extension ProfileNewsFeedVC : UICollectionViewDelegateFlowLayout{
         
     }

     extension ProfileNewsFeedVC : ViewDelegate {
     ...
     extension ProfileNewsFeedVC : AddPostDelegate {
     ...
     extension ProfileNewsFeedVC : YesNoAlertViewDelegate{
     ...
     extension ProfileNewsFeedVC : SwiftPhotoGalleryDataSource,SwiftPhotoGalleryDelegate {
     ...
     extension ProfileNewsFeedVC : UIScrollViewDelegate{
         ...
         func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
             ...
             else if (tbleViewNewsFeed.contentOffset.y + tbleViewNewsFeed.frame.size.height >= tbleViewNewsFeed.contentSize.height)
             {
                 ...
                 if (isFetching == true)
                 {
                    ...
                    self.viewModel?.getDataProfile(UserId: otherUserId  , Search: "",Skip: skip,PageSize: pageSize,SortColumnDir : "",SortColumn: "",ParticularId: UserDefaultExtensionModel.shared.currentUserId)
     ...
     extension ProfileNewsFeedVC : OKAlertViewDelegate{
